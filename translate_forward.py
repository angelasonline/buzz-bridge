...
def build_variant_event(bridge_sk, geohash: str, label: str, v: Variant) -> dict:
    ...
    # "text" and "translation" are the plain-text default (Langlayer canonicalizes
    # the "text" alias to "translation"), so neither gets a banner suffix.
    label_suffix = "" if v.modality in ("text", "translation") else f" · {v.modality}"
